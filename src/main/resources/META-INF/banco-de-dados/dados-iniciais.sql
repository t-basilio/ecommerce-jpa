...
insert into produto (id, nome, preco, data_criacao, descricao) values (3, 'Câmero GoPro Hero 7', 1400.0, date_sub(sysdate(), interval 1 day), 'Desempenho 2x melhor em comparação as cameras normais.');
...
insert into pagamento (pedido_id, status, codigo_barras, tipo_pagamento) values (1, 'PROCESSANDO', '8889999966666666', 'boleto');
insert into pagamento (pedido_id, status, numero_cartao, tipo_pagamento) values (3, 'RECEBIDO', '5555-4444-3333-1111', 'cartao');
insert into pagamento (pedido_id, status, codigo_barras, tipo_pagamento) values (4, 'RECEBIDO', '8889999966666667', 'boleto');
insert into pagamento (pedido_id, status, numero_cartao, tipo_pagamento) values (5, 'RECEBIDO', '5555-6666-3333-1111', 'cartao');
