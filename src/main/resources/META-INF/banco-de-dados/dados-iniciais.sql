...
insert into produto (id, versao, nome, preco, data_criacao, ativo, descricao) values (3, 0, 'Câmero GoPro Hero 7', 1500.0, date_sub(sysdate(), interval 1 day), 'SIM', 'Desempenho 2x melhor em comparação as cameras normais.');
insert into produto (id, versao, nome, preco, data_criacao, ativo, descricao) values (4, 0, 'Tablet Samsung', 1500.0, date_sub(sysdate(), interval 1 day), 'SIM', 'Desempenho 2x melhor em comparação as cameras normais.');
insert into produto (id, versao, nome, preco, data_criacao, ativo, descricao) values (5, 0, 'Câmera Canon 80D', 3500.0, sysdate(), 'NAO', 'O melhor ajuste de foco.');
insert into produto (id, versao, nome, preco, data_criacao, ativo, descricao) values (6, 0, 'Microfone de Lapela', 50.0, sysdate(), 'NAO', 'Produto massa.');
...
insert into pedido (id, versao, cliente_id, total, data_criacao, status) values (1, 0, 1, 2398.0, sysdate(), 'AGUARDANDO');
insert into pedido (id, versao, cliente_id, total, data_criacao, status) values (2, 0, 1, 499.0, date_sub(sysdate(), interval 5 day), 'CANCELADO');
insert into pedido (id, versao, cliente_id, total, data_criacao, status) values (3, 0, 3, 3000.0, date_sub(sysdate(), interval 1 day), 'PAGO');
insert into pedido (id, versao, cliente_id, total, data_criacao, status) values (4, 0, 1, 3500.0, date_sub(sysdate(), interval 2 month), 'PAGO');
insert into pedido (id, versao, cliente_id, total, data_criacao, status) values (5, 0, 2, 499.0, date_sub(sysdate(), interval 1 month), 'PAGO');
insert into pedido (id, versao, cliente_id, total, data_criacao, status) values (6, 0, 1, 799.0, date_sub(sysdate(), interval 2 day), 'PAGO');
insert into pedido (id, versao, cliente_id, total, data_criacao, status) values (7, 0, 2, 1500.0, sysdate(), 'AGUARDANDO');

insert into nota_fiscal(pedido_id, versao, xml, data_emissao) values (3, 0, '<xml />', sysdate())
...
insert into pagamento (pedido_id, versao, status, codigo_barras, tipo_pagamento, data_vencimento) values (1, 0, 'PROCESSANDO', '8889999966666666', 'boleto', date_add(sysdate(), interval 3 day));
...
insert into pagamento (pedido_id, versao, status, codigo_barras, tipo_pagamento, data_vencimento) values (4, 0, 'RECEBIDO', '8889999966666667', 'boleto', date_sub(sysdate(), interval 28 day));
...
insert into pagamento (pedido_id, versao, status, codigo_barras, tipo_pagamento, data_vencimento) values (7, 0, 'PROCESSANDO', '8889999966666668', 'boleto', date_add(sysdate(), interval 2 day));
