    ...
    void agruparEFiltrarResultado() {
         ...
         * Total de vendas por categoria do mês corrente:
            "select c.nome, sum(ip.precoProduto * ip.quantidade) from ItemPedido ip" +
                ...
                " and month(p.dataCriacao) = month(current_date) group by c.id"
        */
