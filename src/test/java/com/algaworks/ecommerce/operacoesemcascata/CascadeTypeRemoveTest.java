...
public class CascadeTypeRemoveTest extends EntityManagerTest {
    ...
    public void removerItensOrfaos() {
        ...
        pedido.getItens().clear(); // Necessário CascadeType.PERSIST e orphanRemoval = true
    ...
    @Test
    public void removerRelacionamentoProdutoCategoria() {
    ...
    public void removerItemPedidoEPedido() {
        ItemPedido itemPedido = entityManager
                .find(ItemPedido.class, new ItemPedidoId(1, 3));
